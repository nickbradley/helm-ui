    ...
    export default {
        ...
        created() {
            ...
            this.$options.fileList = [
                {
                    id: 1,
                    path: path.join(__static, "package.json"),
                    text: {
                        main: "package.json",
                        meta: path.join(__static, "package.json"),
                    },
                    icon: defaultIcon,
                },
                {
                    id: 2,
                    path: path.join(__static, "index.js"),
                    text: {
                        main: "index.js",
                        meta: path.join(__static, "index.js"),
                    },
                    icon: defaultIcon,
                },
                {
                    id: 3,
                    path: path.join(__static, "File.ts"),
                    text: {
                        main: "File.ts",
                        meta: path.join(__static, "File.ts"),
                    },
                    icon: defaultIcon,
                },
                {
                ...
                {
                    id: 5,
                    path: path.join(__static, ".gitignore"),
                    text: {
                        main: ".gitignore",
                        meta: path.join(__static, ".gitignore")
                    },
                    icon: defaultIcon,
                },
                {
                    id: 6,
                    path: path.join(__static, "firefox.png"),
                    text: {
                        main: "firefox.png",
                        meta: path.join(__static, "firefox.png"),
                    },
                    icon: defaultIcon
                },
                {
                    id: 7,
                    path: path.join(__static, "intellij.png"),
                    text: {
                        main: "intellij.png",
                        meta: path.join(__static, "intellij.png"),
                    },
                    icon: defaultIcon
                }
            ];
